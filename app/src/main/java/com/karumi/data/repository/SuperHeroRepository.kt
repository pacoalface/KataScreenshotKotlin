    ...
    private fun fakeData(): List<SuperHero> {
        return listOf(
            ...
            SuperHero(name = "Hulk",
                ...
                isAvenger = true,
                description = "Caught in a gamma bomb explosion while trying to save the life of a " +
                    "teenager, Dr. "
            ...
            SuperHero(name = "Storm",
                ...
                isAvenger = false,
                description = "Ororo Monroe is the descendant of an ancient line of African priestesses, " +
            ...
            SuperHero(name = "Ultron",
                ...
                isAvenger = false,
                description = "Arguably the greatest and certainly the most horrific creation of " +
            ...
            SuperHero(name = "BlackPanther",
                ...
                isAvenger = false,
                description = " T'Challa is a brilliant tactician, strategist, scientist, tracker and a " +
            ...
            SuperHero(name = "Captain America",
                ...
                isAvenger = true,
                description = "Captain America represented the pinnacle of human physical perfection. He " +
            ...
            SuperHero(name = "Winter Soldier",
                ...
                isAvenger = false,
                description = "Olympic-class athlete and exceptional acrobat highly skilled in both unarmed" +
                    " and armed "
            ...
            SuperHero(name = "Captain Marvel",
                ...
                isAvenger = false,
                description = " Ms. Marvel's current powers include flight, enhanced strength, durability " +
